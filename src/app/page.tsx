          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex flex-col text-base sm:text-lg font-geist-sans">
              <div className="space-y-4">
                ...
                <p className="text-gray-600">i've spent a lot of time building things that others have asked, so going forward, i want to spend more time thinking about why things are the way they are and how to improve the systems that we already use</p>
